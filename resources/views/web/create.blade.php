    ...
    <p>
        <div class="row">
            <div class="col">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span style="width: 350px;" class="input-group-text">Watchful.li</span>
                    </div>
                    <input type="text" name="watchful_li" value="{{ old('watchful_li') }}" class="form-control"> {{-- input --}}
                </div>
                {!! $errors->first('watchful_li', '<p style="color:red;" class="help-block">:message</p>') !!}
            </div>
        </div>
    </p>
    <p>
        <div class="row">
            <div class="col">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span style="width: 350px;" class="input-group-text">Pingdom</span>
                    </div>
                    <input type="text" name="pingdom" value="{{ old('pingdom') }}" class="form-control"> {{-- input --}}
                </div>
                {!! $errors->first('pingdom', '<p style="color:red;" class="help-block">:message</p>') !!}
            </div>
        </div>
    </p>
    <p>
        <div class="row">
            <div class="col">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span style="width: 350px;" class="input-group-text">GTM Tracking</span>
                    </div>
                    <input type="text" name="GTM_Tracking" value="{{ old('GTM_Tracking') }}" class="form-control"> {{-- input --}}
                </div>
                {!! $errors->first('GTM_Tracking', '<p style="color:red;" class="help-block">:message</p>') !!}
            </div>
        </div>
    </p>
